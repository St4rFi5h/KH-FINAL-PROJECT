            ...
            <div class="article_right">
                <div class="notiboard_section">
                    ...
                    <div class="page_section section_qna">
                        ...
                        <td><br>
                        <form:input path="noticeTitle" type="text" name="noticeTitle" id="noticeTitle" style="width:100%; height:25px;"/>
                        </td>
                        </tr>
                        <tr>
                        ...
                        <form:textarea path="noticeContent" name="noticeContent" id="noticeContent" rows="10" cols="146"></form:textarea>
