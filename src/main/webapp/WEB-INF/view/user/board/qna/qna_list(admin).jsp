                            ...
                            <div class="accordion_title">
                                <div class="tbl_notice_info">
                                    <div class="infoinner">
                                        ...
                                        <p class="tbl_info_date"><a href="faq_write(admin).html"><input type="button" class="write_btn yb" value="답변완료"/></a>
                            ...
                            <div class="accordion_title">
                                <div class="tbl_notice_info">
                                    <div class="infoinner">
                                        ...
                                        <p class="tbl_info_date"><a href="qna_write(admin).html"><input type="button" class="write_btn yb" value="답변달기"/></a>
                                            <span class="blind">답변버튼</span>
                                        </p>
                                    </div>
                                </div>
