...
<head>
    ...
    <link rel="stylesheet" href="/css/mypage/mypageiwant.css">
                ...
                <div class="modal fade" id="myModal" role="dialog">
                    ...
                    <div class="modal-content" id="modal-div">
                        ...
                        <div class="modal-body">
                            <div>
                                <div id="sorttext"><a  href='/mypage/wannawatch_member?id=${id}&sort=1' style="text-decoration:none; color:black" >가나다순</a></div>
                                <div id="sorttext"><a  href='/mypage/wannawatch_member?id=${id}&sort=2' style="text-decoration:none; color:black">신작순</a></div>
                                <div id="sorttext"><a  href='/mypage/wannawatch_member?id=${id}&sort=3' style="text-decoration:none; color:black">구작순</a></div>
                                <div id="sorttext"><a  href='/mypage/wannawatch_member?id=${id}&sort=4' style="text-decoration:none; color:black">담은순</a></div>
                            </div>
                        </div>
                        <!-- 
