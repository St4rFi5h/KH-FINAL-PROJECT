...
public class CommentDao {
	...
	// 코멘트 기본 select
	public Map<String, Object> selectCommentList(String movieDocId, CommentPage page) {
		
		Map<String, Object> commentListMap = new HashMap<>();
		List<CommentListVo> commentList = new ArrayList<>();
		
		try {
			int totalListSize = mapper.totalListSize(movieDocId);
			
			page.setMovieDocId(movieDocId);
